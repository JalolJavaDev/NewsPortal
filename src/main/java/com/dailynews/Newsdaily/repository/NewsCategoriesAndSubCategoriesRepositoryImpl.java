...
public class NewsCategoriesAndSubCategoriesRepositoryImpl implements NewsCategoriesAndSubCategoriesRepository {
    ...
    public NewsCategoriesAndSubCategoriesRepositoryImpl(JdbcTemplate jdbcTemplate) {
    ...
    public List<NewsCategoriesAndSubCategories> findAllNewsCategory() {
        Query<NewsCategoriesAndSubCategories> query = currentSession().createQuery("select parentId from NewsCategoriesAndSubCategories ", NewsCategoriesAndSubCategories.class);
    ...
    public List<News> findByCategoryName(String categoryName) {
        String HQL = " select parentId from NewsCategoriesAndSubCategories";
    ...
    public List<NewsCategoriesAndSubCategories> findAllSubCategory() {
        javax.persistence.Query allSubCategory = entityManager.createQuery("select parentId from NewsCategoriesAndSubCategories", NewsCategoriesAndSubCategories.class);
    ...
    public NewsCategoriesAndSubCategories findBySubCategoryId(int subCategoryId) {
        javax.persistence.Query subcategoryById = entityManager.createQuery("select parentId from NewsCategoriesAndSubCategories where parentId=:subCategoryId", NewsCategoriesAndSubCategories.class);
    ...
    public List<NewsCategoriesAndSubCategories> findSubCategoryByCategoryId(int categoryId) {
        javax.persistence.Query subCategoryByCategoryId = entityManager.createQuery("select parentId from NewsCategoriesAndSubCategories where parentId=:categoryId", NewsCategoriesAndSubCategories.class);
    ...
    public NewsCategoriesAndSubCategories findBySubCategoryName(String subCategoryName) {
        javax.persistence.Query findSubCategoryByName = entityManager.createQuery("select parentId from NewsCategoriesAndSubCategories where CategoryName=:subCategoryName");
    ...
    public List<NewsCategoriesAndSubCategories> findNewsSubCategoriesByCategoryName(String categoryName) {
        javax.persistence.Query newsCategoryName = entityManager.createQuery("select parentId from NewsCategoriesAndSubCategories where CategoryName=:categoryName");
    ...
    public List<NewsCategoriesAndSubCategories> findSubCategoryChildBySubCategoryName(String subCategoryChild) {
        javax.persistence.Query newsSubCategoryChildName = entityManager.createQuery("select parentId from NewsCategoriesAndSubCategories where CategoryName=:subCategoryChild");
        ...
        javax.persistence.Query subCategories = entityManager.createQuery("select parentId from NewsCategoriesAndSubCategories where parentId=:subCategoryId");
